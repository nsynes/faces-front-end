        ...
        return (
            <div className='instructions-container'>
                <ol type='A'>
                    ...
                    <li>When the detection has finished, similar faces will be automatically clustered. Select the 'Faces' tab to start classifying detected faces.</li>
                </ol>
            </div>
        )
        ...
        return (
            <div className='instructions-container'>
                <ol type='A'>
                    ...
                    <li>If multiple faces need to be individually classfied next to each other, click and drag to classify them.</li>
